...
\ganttbar[bar/.append style={fill=green!40}]{2.1 Captura libcamera C++}{2}{2} \\
\ganttbar[bar/.append style={fill=green!40}]{2.2 Detecção ONNX}{3}{3} \\
\ganttbar[bar/.append style={fill=green!40}]{2.3 Alinhamento facial}{3}{4} \\
\ganttbar[bar/.append style={fill=green!40}]{2.4 Embedding MobileFace}{4}{4} \\
